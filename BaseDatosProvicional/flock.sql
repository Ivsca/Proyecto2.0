...
--
-- Servidor: db
-- Tiempo de generación: 18-09-2025 a las 11:16:01
...
(61, 'Can add tabla vacunas', 16, 'add_tablavacunas'),
(62, 'Can change tabla vacunas', 16, 'change_tablavacunas'),
(63, 'Can delete tabla vacunas', 16, 'delete_tablavacunas'),
(64, 'Can view tabla vacunas', 16, 'view_tablavacunas');
...
(49, 'Yuca', '2025-07-24', '2025-08-20', 50, 'cultivos/images_jAnT6pz.jpeg', 4),
(51, 'Maiz', '2025-07-03', '2025-09-21', 60, 'cultivos/images_7_PqlDgsJ.jpeg', 3),
(52, 'Aguacate', '2025-07-08', '2025-10-04', 4, 'cultivos/Palo_waflaLK.png', 1),
...
(59, 'Mandarina', '2025-06-29', '2025-10-09', 6, 'cultivos/c093586b774282f63a706740a447f32c_HrAMx5j.jpg', 1);
...
(26, 'AppInventario', '0002_cultivo_tipocultivo_fertilizacion_cultivo_tipo', '2025-09-12 12:53:31.541370'),
(27, 'AppInventario', '0003_alter_enfermedades_options_alter_ganado_options_and_more', '2025-09-12 12:53:31.550940'),
(28, 'AppInventario', '0004_ganado_idparcela_and_more', '2025-09-12 15:19:03.583824');
...
('hby0z7w6ab8m64nkwpkzinf6i9sb33i7', 'eyJ1c3VhcmlvX2lkIjo3LCJ1c2VybmFtZSI6Ikp1bGlvXzAiLCJyb2wiOiJVc3VhcmlvIn0:1utpyD:X2g79Smy5ukeEvH5ZPxeVVrQ5DTTzZESpuM96ObEXzs', '2025-09-17 16:04:25.146387'),
...
('lhle67esf5gxr9qqdj5wx1ingak20b7c', 'eyJ1c3VhcmlvX2lkIjo3LCJ1c2VybmFtZSI6Ikp1bGlvXzAiLCJyb2wiOiJVc3VhcmlvIn0:1umAms:vmw03SQsOu5B7B8Ka3Xbggl0thlI98IJEpaBP1qq0nY', '2025-08-27 12:41:02.591948'),
...
CREATE TABLE `ganado` (
  ...
  `LitrosLeche` varchar(10) NOT NULL,
...
INSERT INTO `ganado` (`id`, `CodigoCria`, `Foto`, `Crias`, `LitrosLeche`, `CodigosCrias`, `CodigoPapa`, `CodigoMama`, `Edad`, `InfoVacunas`, `Enfermedades`, `Estado`, `IdParcela`, `Razas`) VALUES
(8, 'ivannaa', '', '3', '12', '[\"12345678\",\"VC004\",\"VC003\"]', 'VC001', 'VC002', '12', '[]', '[{\"disease\":\"Fiebre Aftosa\",\"date\":\"2025-02-12\"},{\"disease\":\"Leptospirosis\",\"date\":\"2025-12-12\"},{\"disease\":\"Mastitis\",\"date\":\"2025-12-12\"}]', 'Activa', 6, 'Brahman con Girolando'),
(9, 'Yojan', 'ganado/20100516_Vacas_Vilarromarís,_Oroso-8-1.jpg', '1', '1', '[\"ivanna\"]', 'ivanna', 'ivanna', '9', '[]', '[]', 'Activa', 3, 'Brahman con Brahman'),
(10, 'juan cachon', 'ganado/Vaca-encerrada-en-un-corral.jpeg', '1', '8', '[\"Yojan\"]', 'Yojan', 'ivanna', '10', '[]', '[]', 'Activa', 6, 'Brahman con Brahman'),
...
(12, 'isabel', 'ganado/vaaaaaaa.webp', '3', '10', '[\"juan cachon\",\"Yojan\",\"hijo de juan\"]', 'juan cachon', 'hijo de juan', '12', '[{\"vaccine\":\"Fiebre Aftosa\",\"amount\":\"123\",\"date\":\"2025-02-02\",\"type\":\"via oral\"}]', '[{\"disease\":\"Fiebre Aftosa\",\"date\":\"2025-02-10\"}]', 'Vendida', 6, 'Angus con Romosinuano'),
...
(14, 'Vas122', 'ganado/mis_vecinas.avif', '2', '10', '[\"juan cachon\",\"ivannaa\"]', 'ivannaa', 'Yojan', '4', '[{\"vaccine\":\"Fiebre Aftosa\",\"amount\":\"1\",\"date\":\"2025-10-21\",\"type\":\"inyeccion\"}]', '[{\"disease\":\"Fiebre Aftosa\",\"date\":\"2025-03-12\"},{\"disease\":\"Actinomicosis\",\"date\":\"2025-04-23\"}]', 'Activa', 2, 'Normando con Cebú'),
...
CREATE TABLE `tipo_cultivo` (
  ...
  `DiasNecesariosParaCosechar` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
INSERT INTO `tipo_cultivo` (`id`, `nombre_tipo`, `DiasNecesariosParaCosechar`) VALUES
(1, 'Zanahoria', 90),
(2, 'Lechuga', 30),
(3, 'Platano', 60),
(4, 'Papa', 120),
...
(1, '', 'Yojan esneyder', 'ceballos higuita', 'gestorempresa1@gmail.com', 1, '1234567891', 'Admin', 'mi_mama_me_mima', 'Usuario'),
(2, '', 'juan carlos', 'alcala martinez', 'yojan12ceballos123@gmail.com', 2, '12331231', 'Admin', 'juan_baila', 'Usuario'),
